                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            <div class="card-body pt-0">
                                ...
                                <div class="p-3">
                                    <h4 class="text-muted font-size-18 mb-1 text-center">Get a free sgr account  by filling  in the data</h4>
                                    <p class="text-muted text-center">Only Goernment licenced users  can use  this part!!!!!!!!.</p>
                                    ...
                                    <form class="form-horizontal mt-4" action="post">
                                        ...
                                        <div class="mb-0 row">
                                            <div class="col-12 mt-4">
                                                <p class="text-muted mb-0 font-size-14">By registering you agree to the SGR <a href="#" class="text-primary">Terms of Use</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
